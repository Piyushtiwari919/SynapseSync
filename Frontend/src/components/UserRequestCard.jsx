...
const UserRequestCard = ({ user }) => {
  ...
  return (
    <div className="relative group flex flex-col items-center w-[47%] md:w-64 bg-[#1e1e22] rounded-3xl p-4 border border-white/5 shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-cyan-500/10">
      {/* Toast */}
      {toast && (
      ...
      <div className="text-center w-full mb-4 grow flex flex-col justify-center">
        ...
        <p className="text-xs text-gray-400 mt-1 line-clamp-2 leading-relaxed h-8">
      ...
      <div className="w-full flex items-center gap-2 mt-auto">
        <button
          ...
          className="h-10 w-10 md:h-11 md:w-11 flex items-center justify-center rounded-full bg-[#2a2a30] text-gray-400 hover:bg-red-500/10 hover:text-red-500 hover:border hover:border-red-500/50 transition-all duration-200 active:scale-90"
          title="Ignore"
        >
          <X size={20} />
        </button>
        <button
          ...
          className="flex-1 h-10 md:h-11 bg-linear-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white rounded-full font-semibold text-sm flex items-center justify-center gap-2 shadow-lg shadow-blue-900/20 transition-all duration-200 active:scale-95 hover:shadow-cyan-500/25"
        >
          <UserCheck size={18} />
          <span>Accept</span>
        </button>
