...
const FeedCard = ({ feed, isProfilePost }) => {
  ...
  const toggleLike = async () => {
    ...
    // This makes the app feel "instant" like Instagram/Twitter.
  ...
  return (
    <div className="w-full bg-[#121214] border border-zinc-800 rounded-2xl overflow-hidden mb-6 shadow-lg transition-all hover:border-zinc-700 group">
            ...
            {showInfo && (
              <>
                ...
                <div className="absolute right-0 top-full mt-2 w-48 bg-[#18181b] border border-zinc-800 rounded-xl shadow-2xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200 origin-top-right">
                  <button className="w-full flex items-center gap-3 px-4 py-3 text-sm text-zinc-300 hover:bg-zinc-800 hover:text-white transition-colors text-left group">
                    <Edit
                      size={16}
                  ...
                  <button className="w-full flex items-center gap-3 px-4 py-3 text-sm text-red-400 hover:bg-red-500/10 transition-colors text-left">
                    <BadgeX size={16} />
      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <button className="flex items-center gap-2 text-zinc-400 hover:text-cyan-400 transition-colors group/comment">
              <div className="p-2 rounded-full group-hover/comment:bg-cyan-500/10 transition-colors">
                <MessageCircle size={22} />
              </div>
            </button>

            <button className="flex items-center gap-2 text-zinc-400 hover:text-green-400 transition-colors group/share">
